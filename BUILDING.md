...
### macOS
A dmg bundling ZAP, its dependencies, a JRE, and OpenJFX (for the Browser View add-on). The Linux/Windows specific add-ons are excluded from this distribution.
