...
### macOS
A dmg bundling ZAP, its dependencies, a JRE, and OpenJFX (for the Browser View add-on, under `ZAP.app/Contents/Java/javafx`). The Linux/Windows specific add-ons are excluded from this distribution.
